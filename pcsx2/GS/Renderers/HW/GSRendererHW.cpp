...
void GSRendererHW::RecordDrawLogEntry() const
{
	...
	rec.tex_cbp = m_cached_ctx.TEX0.CBP;
	rec.tex_clut_cfg = static_cast<u16>((m_cached_ctx.TEX0.CPSM & 0xF) | ((m_cached_ctx.TEX0.CSM & 1) << 4) |
										((m_cached_ctx.TEX0.CSA & 0x1F) << 5) | ((m_cached_ctx.TEX0.CLD & 7) << 10));
