...
#endif
{
	...
	if (PS_SCANMSK & 2)
	{
		...
		// where row / S is exactly integral. ScaledScaleFactor is S/16, the fixed-point convention
		// the texture path uses, and scaling it by 16 is exact, so this recovers S and divides.
