...
# The patch context lines were cut against files byte-identical to this commit, the
# row-for-row cross-check against 04.3-SHADER-LICENCES.md only holds here, and that
# document's closure byte counts are this tree's. Resolving against a newer master
...
def write_ballot(out, checkout, pin, entries, records, counts, offenders, options):
    ...
    parts.append("\n## Cross-check against 04.3-SHADER-LICENCES.md\n")
