...
class ShaderCacheDirectoryPolicy(unittest.TestCase):
    ...
    def test_the_cargo_feature_set_still_builds_metal_only(self):
        ...
        self.assertIn(
            ...
            "every runtime including ones that cache. Re-run the device observation from "
            "04.3-09: the shader cache has stopped being dead code on this build.")
        ...
        self.assertEqual(
            ...
            "Metal reaches librashader-cache, so re-run the device observation from 04.3-09: the "
            "shader cache has stopped being dead code on this build.")
    ...
    def test_the_metal_runtime_still_never_reaches_the_cache_crate(self):
        ...
        for tree in trees:
            ...
            self.assertEqual(
                ...
                "AppDelegate.mm is live rather than pre-emptive. Re-run the device observation "
                "from 04.3-09 and expect Library/Caches/librashader to exist this time.")
