...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "perf.eeFpuClamping.description" to "FPU overflow/rounding accuracy. Exact reproduces the EE's multiplier and divider bit-for-bit, for the few games that check results exactly. It is the slowest setting by some way.",
    ...
    "perf.vu1Clamping.description" to "Clamping for VU1 alone. Same as VU0 follows the VU Clamping setting; anything else overrides it, so a game that needs VU0 accurate can leave VU1 cheaper.",
    "perf.vu1Clamping.label" to "VU1 Clamping",
    "perf.vu1RoundMode.label" to "VU1 Round Mode",
    "perf.vuClamping.description" to "VU float clamping for VU0, and VU1 unless VU1 Clamping overrides it. Exact adds the VU's own arithmetic and status flags on top of Extra+Sign: the most accurate and slowest setting.",
